...
export const setCookies = (cookies: CookiesDto) => {
    Cookies.set("accountId", cookies.accountId?.toString() || "", { path: "/", expires: 14 });
    ...
    Cookies.set("pictureUrl", cookies.pictureUrl || "", { path: "/", expires: 14 });
    Cookies.set("type", cookies.type || "", { path: "/", expires: 14 });
    Cookies.set("phone", cookies.phone || "", { path: "/", expires: 14 });
    Cookies.set("organisationIds", JSON.stringify(cookies.organisationIds), { path: "/", expires: 14 });
};
