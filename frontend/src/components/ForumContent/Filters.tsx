...
import { Drawer, DrawerTrigger, DrawerClose, DrawerContent, DrawerHeader, DrawerTitle, DrawerDescription } from "@/components/ui/drawer";
                                ...
                                <SelectContent>
                                    <div className="flex justify-center items-center">
                                        <Calendar
                                            ...
                                            defaultMonth={occurrenceDate ? new Date(occurrenceDate) : undefined}
                                            className=" px-2 justify-center items-center"
                                            classNames={{
                                                day_today: "border border-secondaryColour text-accent-foreground",
                                                day: cn(
                            ...
                            <div className="flex flex-col space-y-2">
                                <div className="flex justify-between items-center w-full">
                                    <label htmlFor="latest" className="text-xs">
                                        Latest <span className="text-fadedPrimaryColour">(default)</span>
                                    </label>

                                    <RadioGroupItem value="latest" id="latest" checked={sortOption === "latest"} />
                                </div>
                                <div className="flex justify-between items-center w-full">
                                    <label htmlFor="oldest" className="text-xs">Oldest</label>
                                    <RadioGroupItem value="oldest" id="oldest" checked={sortOption === "oldest"} />
                                </div>
                                <div className="flex justify-between items-center w-full">
                                    <label htmlFor="Most Likes" className="text-xs">Most Likes</label>
                                    <RadioGroupItem value="Most Likes" id="Most Likes" checked={sortOption === "Most Likes"} />
                                </div>
                            </div>
                        </RadioGroup>
                        ...
                        <RadioGroup value={type} onValueChange={(value) => setType(value)}>
                            ...
                            <div className="flex flex-col space-y-2">
                                ...
                                <div className="flex justify-between items-center w-full">
                                    ...
                                    <RadioGroupItem value="TRAINING" id="training" checked={type === "TRAINING"} />
                                </div>
                                <div className="flex justify-between items-center w-full">
                                ...
                                <div className="flex justify-between items-center w-full">
                                    <label htmlFor="special" className="text-xs">Special</label>
                                    <RadioGroupItem value="SPECIAL" id="special" checked={type === "SPECIAL"} />
                                </div>
                            </div>
                        </RadioGroup>
