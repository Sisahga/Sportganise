...
//   //
//   //   await waitFor(() => {
//   //     // Check that createChannel was called
//   //     expect(mockCreateChannel).toHaveBeenCalled();
//   //
//   //     // Inspect the argument passed to createChannel
//   //     const [[actualChannelDetails]] = mockCreateChannel.mock.calls;
//   //
//   //     console.log("Actual Channel Details:", actualChannelDetails);
//   //
//   //     expect(actualChannelDetails).toEqual({
//   //           channelId: null,
//   //           channelName: "",
//   //           channelType: "SIMPLE",
//   //           memberIds: [1], // Ensure this matches the `accountId` from selected users
//   //           avatarUrl: null,
//   //           createdAt: expect.any(String), // Allow dynamic `createdAt`
//   //         }
//   //     );
//   //
