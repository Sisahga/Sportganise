...
import {differenceInDays, differenceInMinutes, format, isToday, parseISO,} from "date-fns";
  ...
  return (
      <div className="flex flex-col justify-end overflow-y-scroll scroll-smooth px-4 pt-4 pb-2 w-full min-h-full">
        {messages.map((message, index) => {
          ...
          return (
              <div id={message.messageId.toString()} key={message.messageId} className="mb-4">
                    ...
                    <>
                      ...
                      >
                        ...
                        >
                          ...
                          <div id={`msg-status-${message.messageId}`} className="flex flex-col gap-2 items-end max-w-full relative">
                            {
                            ...
                            {index === messages.length - 1 &&
                                message.senderId === currentUserId && (
                                <p className="secondary-colour text-xs"><b>{status}</b></p>
                            )}
                          </div>
                        </div>
                      </div>
