...
const ChannelSettingsDropdown = ({channelType} : ChannelSettingsDropdownProps) => {
      ...
      <>
        ...
        <AlertDialog open={isBlockOpen} onOpenChange={setIsBlockOpen}>
          <AlertDialogContent className="font-font" style={{maxWidth: "90vw"}}>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel
                  className="bg-white text-primaryColour hover:bg-fadedPrimaryColour hover:text-white font-font">
                Cancel
              </AlertDialogCancel>
              <AlertDialogAction
                  onClick={handleBlock}
