...
const ChatMessageAttachments = ({ attachments }: { attachments: Attachment[] }) => {
                    ...
                    .map((attachment) => (
                        <div key={attachment.attachmentUrl} className="shadow-lg h-fit">
                          <img
                              ...
                              `}
                              onClick={() => {handleImageClicked(attachment)}}
        ...
        {attachments.some(att => att.fileType === AttachmentType.FILE) && (
            <div className="flex flex-col gap-2 items-end">
              {attachments
                  ...
                  .map((attachment) => (
                      <div key={attachment.attachmentUrl} className="flex items-center text-sm gap-2 bg-gray-200 text-gray-800 px-3 py-2 rounded-2xl shadow-lg w-fit">
