      ...
      <div className="px-4">
        <div className="py-3 bg-white mt-4 rounded-lg shadow-lg">
          <div className="flex flex-col">
            <div><h2 className="px-4 text-lg primary-colour font-bold">Messages</h2></div>
            <div className="flex flex-col">
                        ...
                        extraInfo={
                          <>
                            <span className="text-sm text-gray-400 font-regular">
                              {channel.lastEvent ? formatDatetime(channel.lastEvent) : ""}
                            </span>
                            {channel.read  ? null :
                                (
                                  <div className="flex justify-end">
                                    <Dot className="secondary-colour" strokeWidth={8}></Dot>
                                  </div>
                                )
                            }
                          </>
