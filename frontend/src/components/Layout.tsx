...
const hideHeaderPaths = ["/pages/DirectMessagesDashboard", "/pages/DirectMessageChannelPage"]; // Header hidden on both
...
const fullWidthPaths = ["/pages/DirectMessagesDashboard", "/pages/DirectMessageChannelPage"]; // Full-width layout on these paths
