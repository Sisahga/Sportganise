...
function useSetApproverDeleteStatus() {
  const setApproverDeleteStatus =
      async (setApproverDeleteStatus: SetDeleteApproverStatusDto) => {
    return await directMessagingApi.setApproverDeleteStatus(setApproverDeleteStatus);
  }
  return {
