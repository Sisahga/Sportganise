...
class ProgramControllerTest {
    ...
    public void getParticipantsInSession_Success() throws Exception {
        ...
        ProgramParticipantDTO participant1 = new ProgramParticipantDTO(1, Role.PLAYER, "johndoe@gmail.com", 
                                                "123 Boulevard Random", "5141234567", "John", "Doe");
        ProgramParticipantDTO participant2 = new ProgramParticipantDTO(2, Role.PLAYER, "janesmith@gmail.com", 
                                                "123 Avenue Random", "5148901234", "Jane", "Smith");
    ...
    // Empty instead of Forbidden, because eventually players will see other details of the session but just not the participants
    @Test
    public void getParticipantsInSession_Empty() throws Exception {
        ...
        // Note: for now will leave it as empty, but later, I will make it so that players can see other session details
