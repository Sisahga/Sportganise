...
public class DirectMessageChannelServiceUnitTest {
    ...
    public void createDirectMessageChannelTest_WithoutChannelNameShort() {
        ...
        given(accountRepository.findFirstNamesByAccountId(dmChannelDTO.getMemberIds())).willReturn(Arrays.asList("Brett", "Aaron"));
        // Mock the repository save call
        given(directMessageChannelRepository.save(any(DirectMessageChannel.class))).willReturn(dmChannel);
        // Call the service method
        CreateDirectMessageChannelDto result = directMessageChannelService.createDirectMessageChannel(
    ...
    public void createDirectMessageChannelTest_WithoutChannelNameLong() {
        ...
        given(accountRepository.findFirstNamesByAccountId(longTestMemberIds)).willReturn(Arrays.asList("James", "Mark",
                "Brett", "Alex", "Mindy", "Frederic", "Cleopatra"));
        // Mock the repository save call
        given(directMessageChannelRepository.save(any(DirectMessageChannel.class))).willReturn(dmChannel);
        // Call the service method
        CreateDirectMessageChannelDto result = directMessageChannelService.createDirectMessageChannel(
