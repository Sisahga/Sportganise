...
class DirectMessageChannelControllerUnitTest {
    ...
    @MockBean
    private DirectMessageChannelService dmChannelService;
    ...
    void createDirectMessageChannelTest() throws Exception {
        given(dmChannelService.createDirectMessageChannel(createDmChannelDTO.getMemberIds(), createDmChannelDTO.getChannelName())).willReturn(createDmChannelDTO);
        mockMvc.perform(MockMvcRequestBuilders.post("/api/messaging/create-channel")
