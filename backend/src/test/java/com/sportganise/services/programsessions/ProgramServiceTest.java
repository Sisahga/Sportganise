...
public class ProgramServiceTest {
    ...
    public void testGetProgramDetails() {
        ...
        // Mock attachments
        List<ProgramAttachment> mockAttachments = List.of(
    ...
    void testGetPrograms() {
        ...
        // Mock attachments
        List<ProgramAttachment> mockAttachments1 = List.of(
                new ProgramAttachment(1, "attachment1.url"),
                new ProgramAttachment(1, "attachment2.url"));
        Mockito.when(programAttachmentRepository.findAttachmentsByProgramId(1))
        ...
        // Mock attachments
        List<ProgramAttachment> mockAttachments2 = List.of(
                new ProgramAttachment(1, "attachment3.url"));
