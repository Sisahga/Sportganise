...
public class ProgramServiceTest {
        ...
        /*
         * Commenting out for new as I still need to figure some of the underlying
         * methods
         ...
         * MultipartFile mockFile = new MockMultipartFile("file", "test.pdf",
         * "application/pdf", "dummy content".getBytes());
         * 
         * // Mock repository behavior
         * Mockito.when(programRepository.findAll()).thenReturn(Collections.emptyList())
         ...
         * 
         * // Call the method
         * ProgramDto programDto = programService.createProgramDto(programType, title,
         * description, capacity,
         * occurrenceDate, durationMins, isRecurring, expiryDate, frequency, location,
         * visibility, mockFile);
         * 
         * assertNotNull(programDto);
         * assertEquals("file_path", programDto.getAttachment()); // Check that file
         ...
         * 
         * // Mock repository behavior
         * Program existingProgram = new Program("Training", "Existing Program",
         * "Existing Description", 20,
         * LocalDateTime.of(2024, 1, 15, 10, 0, 0, 0), 120, true, LocalDateTime.of(2024,
         * 1, 30, 10, 0, 0, 0),
         * "daily", "Gym", "Public", "file_path");
         * Mockito.when(programRepository.findAll()).thenReturn(Collections.
         * singletonList(existingProgram)); // One existing program
         * 
         * // TODO: Mock file upload behavior
         * //
         * Mockito.when(fileStorageService.storeFile(mockFile)).thenReturn("file_path");
         ...
         * 
         * Mockito.when(programRepository.findById(1)).thenReturn(Optional.of(
         * existingProgram));
         * 
         ...
         * assertEquals(LocalDateTime.of(2024, 1, 15, 10, 0),
         * savedProgram.getOccurrenceDate());
         * assertEquals(90, savedProgram.getDurationMins());
         * assertFalse(savedProgram.isRecurring());
         * assertEquals(LocalDateTime.of(2024, 2, 1, 10, 0),
         * savedProgram.getExpiryDate());
        ...
        void testModifyProgram_ProgramNotFound() {
                ...
                EntityNotFoundException exception = assertThrows(
                                ...
                                () -> programService.modifyProgram(
                                                programDtoToModify, "Updated Type", "Updated Title",
                                                "Updated Description",
                                                30,
                                                LocalDateTime.of(2024, 1, 15, 10, 0), 90, false,
                                                LocalDateTime.of(2024, 2, 1, 10, 0), "daily", "Updated Location",
                                                "private",
                                                null));
