...
public class ProgramServiceTest {
  ...
  void testGetPrograms() {
    ...
    Mockito.when(programRepository.findPrograms())
        .thenReturn(Arrays.asList(mockProgram1, mockProgram2));
    ...
    // Verify that we have retrieved the correct programDto at index 0 (Training program 1) along
    // with the correct
    // details/attributes
    ...
    // Verify that we have retrieved the correct programDto at index 1 (Training program 2) along
    // with the correct
    // details/attributes
