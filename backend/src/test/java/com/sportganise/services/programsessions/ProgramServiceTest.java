...
public class ProgramServiceTest {
    ...
    void testGetPrograms() {
        // Mock a Program object with the below attributes
        Program mockProgram1 = Program.builder()
                .programId(1)
                .programType("Training")
        ...
        Program mockProgram2 = Program.builder()
                .programId(1)
                .programType("Training")
        ...
        Mockito.when(programRepository.findPrograms()).thenReturn(Arrays.asList(mockProgram1, mockProgram2));
        ...
        // Verify that we have retrieved the correct programDto at index 0 (Training program 1) along with the correct
        // details/attributes
        assertEquals("Training", programDtos.get(0).getProgramType());
        assertEquals("Training Program 1", programDtos.get(0).getTitle());
        assertEquals("This is training program 1.", programDtos.get(0).getDescription());
        assertEquals(10, programDtos.get(0).getCapacity());
        assertEquals(
                ZonedDateTime.of(LocalDate.of(2025, 5, 15), LocalTime.of(10, 0), ZoneId.systemDefault()),
                programDtos.get(0).getOccurrenceDate());
        assertEquals(120, programDtos.get(0).getDurationMins());
        assertFalse(programDtos.get(0).isRecurring());
        assertEquals(
                ZonedDateTime.of(LocalDate.of(2025, 5, 16), LocalTime.of(0, 0), ZoneId.systemDefault()),
                programDtos.get(0).getExpiryDate());
        assertEquals("None", programDtos.get(0).getFrequency());
        assertEquals("111 Random Ave", programDtos.get(0).getLocation());
        assertEquals("public", programDtos.get(0).getVisibility());
        assertEquals("/banner.pdf", programDtos.get(0).getAttachments().get(0));
        
        // Verify that we have retrieved the correct programDto at index 1 (Training program 2) along with the correct
        // details/attributes
        assertEquals("Training", programDtos.get(1).getProgramType());
        assertEquals("Training Program 2", programDtos.get(1).getTitle());
        assertEquals("This is training program 2.", programDtos.get(1).getDescription());
        assertEquals(10, programDtos.get(1).getCapacity());
        assertEquals(
                ZonedDateTime.of(LocalDate.of(2025, 6, 15), LocalTime.of(10, 0), ZoneId.systemDefault()),
                programDtos.get(1).getOccurrenceDate());
        assertEquals(120, programDtos.get(1).getDurationMins());
        assertFalse(programDtos.get(0).isRecurring());
        assertEquals(
                ZonedDateTime.of(LocalDate.of(2025, 6, 16), LocalTime.of(0, 0), ZoneId.systemDefault()),
                programDtos.get(1).getExpiryDate());
        assertEquals("None", programDtos.get(1).getFrequency());
        assertEquals("111 Random Ave", programDtos.get(1).getLocation());
        assertEquals("public", programDtos.get(1).getVisibility());
        assertEquals("/banner.pdf", programDtos.get(1).getAttachments().get(0));
    }
