...
public class BlocklistService {
  ...
  public void blockUser(int accountId, int blockedAccountId) {
    ...
    log.info(
        "User with account ID {} has blocked user with account ID {}", accountId, blockedAccountId);
  }

  /**
   * Unblocks a user.
   *
   * @param accountId The account ID of the user unblocking the other user
   * @param blockedAccountId The account ID of the user being unblocked
   */
  public void unblockUser(int accountId, int blockedAccountId) {
    ...
    log.info(
        "User with account ID {} has unblocked user with account ID {}",
        accountId,
        blockedAccountId);
  }
}
